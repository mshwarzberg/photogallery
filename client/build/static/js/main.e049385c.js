...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CreateAccount = __webpack_require__(8);
	...
	var _ViewPhotos = __webpack_require__(12);
	
	var _ViewPhotos2 = _interopRequireDefault(_ViewPhotos);
	...
	function App() {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      null,
	      _react2.default.createElement(_reactRouterDom.Route, { element: _react2.default.createElement(_ViewPhotos2.default, null), path: "/gallery" }),
	      _react2.default.createElement(_reactRouterDom.Route, { element: _react2.default.createElement(_Upload2.default, null), path: "/upload" }),
	      _react2.default.createElement(_reactRouterDom.Route, { element: _react2.default.createElement(_Home2.default, null), path: "/" }),
	      _react2.default.createElement(_reactRouterDom.Route, { element: _react2.default.createElement(_CreateAccount2.default, null), path: "/register" }),
	      _react2.default.createElement(_reactRouterDom.Route, { element: _react2.default.createElement(_Profile2.default, null), path: "/profile" }),
	      _react2.default.createElement(_reactRouterDom.Route, { element: _react2.default.createElement(_Login2.default, null), path: "/login" })
	    )
	  );
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function CreateAccount() {
	  ...
	  var _useState = (0, _react.useState)(true),
	      ...
	      allowedToSubmit = _useState2[0],
	      setAllowedToSubmit = _useState2[1];
	  ...
	  var _useState5 = (0, _react.useState)({
	    ...
	    password: ""
	      ...
	      registerInput = _useState6[0],
	      setRegisterInput = _useState6[1];
	
	  function validateInp() {
	    var username = registerInput.username;
	    var email = registerInput.email;
	  ...
	  function registerUser(e) {
	    ...
	    validateInp(registerInput.username, registerInput.email, registerInput.password);
	    ...
	    if (!allowedToSubmit.notallowed) {
	      ...
	      fetch("/api/register", fetchOptions).then(function () {
	        var _ref = _asyncToGenerator(_regenerator2.default.mark(function _callee(res) {
	          var response;
	            ...
	            while (1) {
	              switch (_context.prev = _context.next) {
	                ...
	                case 2:
	                  ...
	                  return _context.abrupt("return", setErrMessage("Username or email already exists"));
	  ...
	  function changeRegisterInput(e) {
	    ...
	    setRegisterInput(function (prevRegisterInput) {
	      return Object.assign({}, prevRegisterInput, _defineProperty({}, name, value));
	    });
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        "form",
	        { onSubmit: registerUser, className: "register--form" },
	        _react2.default.createElement(
	          "label",
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Login() {
	  ...
	  function loginInputChange(e) {
	    ...
	    setLoginInput(function (prevLoginInput) {
	      return Object.assign({}, prevLoginInput, _defineProperty({}, name, value));
	    });
	  }
	  ...
	  function loginUser(e) {
	    ...
	    fetch("/api/login", fetchOptions).then(function () {
	      var _ref = _asyncToGenerator(_regenerator2.default.mark(function _callee(res) {
	        var _ref2, msg, token;
	          ...
	          while (1) {
	            switch (_context.prev = _context.next) {
	              ...
	              case 2:
	                ...
	                return _context.abrupt("return", setMessage(msg));
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        "form",
	        { onSubmit: loginUser, className: "login--form" },
	        _react2.default.createElement(
	          "label",
	        ...
	        _react2.default.createElement(
	          "button",
	          { type: "submit", id: "login--submit", onClick: loginUser },
	          "Log In"
	        )
	      )
	    )
	...
	function Profile() {
	  ...
	  (0, _react.useEffect)(function () {
	        ...
	        return _regenerator2.default.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              ...
	              case 2:
	                response = _context.sent;
	                overall = shortenSizeWord(response.data.username);
	                average = shortenSizeWord(response.data.email);
	
	                setUserInfo(function (prevInfo) {
	                  return Object.assign({}, prevInfo, {
	                    username: overall,
	                    email: average
	                  });
	                });
	    ...
	    fetch("/api/profile/getinfo", {
	      ...
	      var _ref2 = _asyncToGenerator(_regenerator2.default.mark(function _callee2(res) {
	        var response, overall, average;
	          ...
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              ...
	              case 2:
	                ...
	                overall = shortenSizeWord(response.dataConsumed);
	                average = shortenSizeWord(response.averagesize);
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      null,
	      "You have ",
	      userInfo.numberofimages,
	      " images stored, a total of",
	      " ",
	      userInfo.storageused,
	      " used, with an average image size of",
	      " ",
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Upload() {
	  ...
	  var _useState5 = (0, _react.useState)(true),
	      _useState6 = _slicedToArray(_useState5, 2),
	      filesNotReady = _useState6[0],
	      setFilesNotReady = _useState6[1];
	  ...
	  function uploadFiles() {
	    ...
	    if (files.length === undefined) {
	      ...
	      fetch("/api/upload/multiple", {
	        ...
	        var _ref3 = _asyncToGenerator(_regenerator2.default.mark(function _callee3(res) {
	  ...
	  return _react2.default.createElement(
	    "div",
	    { className: "page", id: "upload--page" },
	    _react2.default.createElement(
	      "div",
	      { className: "upload--choose-files" },
	      _react2.default.createElement(
	        "label",
	        { className: "upload--choose-button", htmlFor: "upload--choose-one" },
	        "Choose An Image"
	      ),
	      _react2.default.createElement("input", {
	    ...
	    isLoading && _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        !filesNotReady && files.length === undefined ? 'Image is' : 'Images are',
	        " uploading. Please be patient..."
	      ),
	      _react2.default.createElement("img", { className: "upload--spinner", src: _Loading2.default, alt: "loading" })
	    )
	  );
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function ViewPhotos() {
	  var _useState = (0, _react.useState)(0),
	      _useState2 = _slicedToArray(_useState, 2),
	      APIcalls = _useState2[0],
	      setAPIcalls = _useState2[1];
	  ...
	  (0, _react.useEffect)(function () {
	    setImageData(function (prevImageData) {
	              ...
	              while (1) {
	                switch (_context.prev = _context.next) {
	                  ...
	                  case 2:
	                    ...
	                    imageRatio = response.dimensions.split("x")[0] / response.dimensions.split("x")[1];
	                    ...
	                    setImageData(function (prevImageData) {
	                      return [].concat(_toConsumableArray(prevImageData), [{
	                ...
	                switch (_context2.prev = _context2.next) {
	                  ...
	                  case 2:
	                    ...
	                    setImages(function (prevImages) {
	                      return [].concat(_toConsumableArray(prevImages), [{ imageURL: imageURL, value: APIcalls }]);
	                    });
	  ...
	  function viewIcons(value, bool) {
	    setImageData(function (prevImageData) {
	      var newData = prevImageData.map(function (newImageData) {
	        return newImageData.value === value ? Object.assign({}, newImageData, { showicon: bool }) : Object.assign({}, newImageData, { showicon: false });
	      });
	      return newData;
	    });
	  }
	  ...
	  function focusOnImage(value, bool) {
	    setImageData(function (prevImageData) {
	      var newData = prevImageData.map(function (newImageData) {
	        return newImageData.value === value ? Object.assign({}, newImageData, { active: bool }) : Object.assign({}, newImageData, { active: false });
	      });
	      return newData;
	    });
	  }
	
	  var renderImages = images.map(function (image) {
	    if (imageData[image.value]) {
	      var size = getImageSize(imageData[image.value].filesize);
	      var htmlclass = "viewphotos--image-" + imageData[image.value].imageratio;
	      return _react2.default.createElement(
	        "div",
	        {
	          className: "viewphotos--image-block",
	          id: htmlclass,
	          title: "Name: " + imageData[image.value].name + "\nDimensions: " + imageData[image.value].dimensions + "\nSize: " + size,
	          onClick: function onClick() {
	        ...
	        imageData[image.value].showicon && _react2.default.createElement("img", {
	          src: _Trash2.default,
	          alt: "trash",
	  ...
	  var renderFocus = images.map(function (image) {
	    if (imageData[image.value]) {
	      var size = getImageSize(imageData[image.value].filesize);
	  ...
	  return _react2.default.createElement(
	    "div",
	    { className: "page", id: "viewphotos--page" },
	    _react2.default.createElement(
	      "h1",
	      null,
	      APIcalls,
	...
	function Home() {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      '\xA0you can begin to upload all your photos and view them right away for the most streamlined experience ever.'
	    )
	  );
	}
	...
	function Navbar() {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        "a",
	        { href: "/", id: "nav--home-link", className: "navbar--links" },
	        "Home"
	      ),
	      !isLoggedIn ? _react2.default.createElement(
	        "a",
	        { href: "/login", id: "nav--login-link", className: "navbar--links" },
	        "Login"
	      ) : _react2.default.createElement(
	        "div",
	        null,
	        ...
	        _react2.default.createElement(
	          "a",
	          { href: "/upload", id: "nav--upload-link", className: "navbar--links" },
	          "Upload"
	        ),
	        _react2.default.createElement(
	          "a",
	          { href: "/profile", id: "nav--profile-link", className: "navbar--links" },
	          "Profile"
	        )
	      )
	    ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMClient = _interopRequireWildcard(_client);
	...
	root.render(_react2.default.createElement(_App2.default, { tab: "home" }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	'use strict';var aa=__webpack_require__(1),ba=__webpack_require__(40);function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var ca=new Set,da={};function ea(a,b){fa(a,b);fa(a+"Capture",b)}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "static/media/Loading.5572838d.gif";

/***/ },
/* 44 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "static/media/Trash.22031e38.png";
...
/***/ }
/******/ ])));
//# sourceMappingURL=main.e049385c.js.map